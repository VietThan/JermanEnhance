 ...
 *
 *=========================================================================*/
#ifndef itkJermanObjectnessMeasureImageFilter_h
#define itkJermanObjectnessMeasureImageFilter_h
...
namespace itk
{
/** \class JermanObjectnessMeasureImageFilter
...
class ITK_TEMPLATE_EXPORT JermanObjectnessMeasureImageFilter:public
  ImageToImageFilter< TInputImage, TOutputImage >
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(JermanObjectnessMeasureImageFilter);

  /** Standard class type aliases. */
  using Self = JermanObjectnessMeasureImageFilter;
  ...
  itkTypeMacro(JermanObjectnessMeasureImageFilter, ImageToImageFilter);
...
protected:
  JermanObjectnessMeasureImageFilter();
  ~JermanObjectnessMeasureImageFilter() override = default;
...
#include "itkJermanObjectnessMeasureImageFilter.hxx"
#endif
